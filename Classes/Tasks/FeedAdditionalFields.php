...
class FeedAdditionalFields implements \TYPO3\CMS\Scheduler\AdditionalFieldProviderInterface
{
    ...
    public function getAdditionalFields(array &$taskInfo, $task, \TYPO3\CMS\Scheduler\Controller\SchedulerModuleController $parentObject)
    {
        ...
        $fieldHtml = '<input type="text" name="tx_scheduler[' . $fieldID . ']" id="' . $fieldID . '" size="50" maxlength="255" value="' . $task->wsFacebookFeedSecret . '">';
        $additionalFields[$fieldID] = array(
            'code' => $fieldHtml,
            'label' => 'LLL:EXT:ws_facebook_feed/Resources/Private/Language/locallang_db.xlf:task.feed.wsFacebookFeedSecret',
            'cshKey' => '',
            'cshLabel' => $fieldID
        );
